...
// Code for change password 
  if(isset($_POST['submit']))
  {
    ...
    $_SESSION['msg']="Pegawai Telah Di Update";
  ...
  <head>
    ...
    <title>SIM PEG | Edit Pegawai</title>
    <meta charset="utf-8">
                ...
                if($query -> rowCount() > 0)
                {
                  foreach($results as $result)
                  {
                    ...
                    <div class="form-group">
                      <label type="text" name="facilities" class="control-label">Nama Pegawai</label>
                      <input type="text" class="form-control" value="<?php echo htmlentities($result->BrandName);?>" name="brand" id="brand" required>
                    </div>
                  <?php }} ?>
                  <div class="form-group">
                    <button class="btn btn-primary" type="submit" name="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i> Update Pegawai</button>
                  </div>
                </form>
              </div>
