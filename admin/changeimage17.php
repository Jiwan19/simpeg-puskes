          ...
          <div class="tile">
            ...
            <form method="post" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label class="control-label">Current Image6</label>
                <?php 
                $id=intval($_GET['imgid']);
                ...
                if($query->rowCount() > 0)
                {
                  ...
                  <div class="form-group">
                    <label class="control-label">Upload New Image 17</label>
                    <input type="file" class="form-control" name="img17" required>
                  </div>
                </div>
