...
{ 
  ...
  <head>
    ...
    <title>SIM PEG | Manage Pegawai</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-pencil"></i> Manage Pegawai</h1>
        </div>
      </div>
            ...
            <div class="tile-body">
             ...
             {?>
              <div class="alert alert-danger">
                ...
                <strong>Data Pegawai Dihapus</strong>   <?php echo htmlentities($_SESSION['delmsg']);?><?php echo htmlentities($_SESSION['delmsg']="");?>
              </div>
            <?php } ?>
