...
if ( !empty($_POST)) {
    ...
    if (empty($tempatlahir)) {
        $tempatlahirError = 'Please enter Name';
        $valid = false;
    }
    ...
    if ($valid) {
        ...
        $sql = "INSERT INTO tbpegawai(nip,nama,jeniskelamin,jabatan,statusperkawinan,agama,tempatlahir,tanggallahir,statuspegawai,alamat,telepon) values(?, ?, ?, ?, ?,  ?, ?, ?, ?, ?, ?)";
        $q = $pdo->prepare($sql);
...
<body>
    <div class="container">
            ...
            <div class="control-group <?php echo !empty($jeniskelaminError)?'error':'';?>">
                ...
                <div class="controls">
                    <input name="jeniskelamin" type="radio"  placeholder="Jenis Kelamin" value="Laki-laki">Laki-laki
                    <input name="jeniskelamin" type="radio"  placeholder="Jenis Kelamin" value="Perempuan"?>Perempuan
