...
// Code for change password 
  if(isset($_POST['submit']))
  {
    ...
    if($lastInsertId)
    {
      $_SESSION['msg']="Create Data Pegawai";
    }
    else 
    {
  ...
  <head>
    ...
    <title>SIM PEG | Create Data Pegawai</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-pencil"></i> Create Pegawai</h1>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              ...
              <form method="post" name="chngpwd" onSubmit="return valid();">
                ...
                <div class="form-group">
                  <button class="btn btn-primary" type="submit" name="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i> Create Pegawai</button>
                </div>
              </form>
            </div>
