...
{ 
  ...
  if(isset($_REQUEST['del']))
  {
    ...
    $query -> execute();
    $_SESSION['msg']="Data Dokumen Telah Dihapus";
  }
  ...
  <head>
    ...
    <title>SIM PEG | Manage Dokumen</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-pencil"></i> Manage Dokumen</h1>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            ...
            <script type="datatabel/buttons.search.min.js"></script>
            <script>
